...
if [ ! -z $DATABASE_PASSWORD ] 
	...
	$MYSQL_DUMP -u$DATABASE_USER -p$DATABASE_PASSWORD -h$DATABASE_HOST $DATABASE_NAME > $BACKUP_FILENAME
	
else 

	$MYSQL_DUMP -u$DATABASE_USER -h$DATABASE_HOST $DATABASE_NAME > $BACKUP_FILENAME
